#!/usr/bin/python3
"""
5-rectangle: Module that defines a Rectangle class.
...
validation, methods for calculation (area/perimeter), string
representation methods (__str__ and __repr__), and a destructor (__del__).
"""
