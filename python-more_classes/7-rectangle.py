#!/usr/bin/python3
"""
7-rectangle: Module that defines a Rectangle class with an instance counter
and a custom symbol for printing the rectangle.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        # We need to explicitly cast the symbol to a string for multiplication
        # since it can be "any type" (e.g., a list as shown in the test case).
